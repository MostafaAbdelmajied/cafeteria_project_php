    ...
    <div class="rounded-3xl bg-white/90 p-8 shadow-2xl shadow-orange-100">
        ...
        <form class="mt-6 grid gap-4 sm:grid-cols-2" data-validate-form action="<?= $formAction ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="sm:col-span-2" data-field>
                ...
                <div class="mt-2">
                    <label class="flex w-full cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed <?= isset($_SESSION['errors']['profile_picture']) ? 'border-red-300 bg-red-50/50' : 'border-orange-200 bg-orange-50/50' ?> px-6 py-6 transition-all hover:bg-orange-100/50">
