...
<main class="mx-auto w-full max-w-4xl px-6 py-10">
  ...
  <div class="mb-6 flex flex-wrap items-end justify-between gap-4">
    ...
    <form method="GET" action="<?= url('/my-orders') ?>" class="flex flex-wrap items-end gap-3">
  ...
  <?php if (empty($orders)): ?>
    <div class="rounded-3xl border border-orange-100 bg-white/90 px-8 py-16 text-center shadow-lg shadow-orange-100">
      ...
      <p class="mt-1 text-sm text-slate-400">
        ...
        <a href="<?= url('/home') ?>" class="text-brand-600 hover:underline">home page</a>.
      </p>
    </div>
      ...
      <table class="w-full text-left text-sm">
        <thead class="bg-orange-50 text-xs uppercase  tracking-wide text-slate-500">
          <tr>
            ...
            <th class="px-6 py-3">Delivery Room</th>
        ...
        <tbody class="divide-y divide-orange-100">
          ...
          ?>
            <tr class="transition hover:bg-orange-50/50">
              ...
              <td class="px-6 py-4 text-slate-500"><?= htmlspecialchars($order['order_date']) ?></td>
              <td class="px-6 py-4"><?= htmlspecialchars($order['delivery_room']) ?></td>
              <td class="px-6 py-4 text-right font-semibold"><?= number_format((float)$order['total_amount'], 2) ?> EGP</td>
              ...
              <td class="px-6 py-4 text-center">
                <div class="flex items-center justify-center gap-2">
                  <a href="<?= url('/order-details') ?>?id=<?= $orderId ?>"
