...
<main class="mx-auto w-full max-w-3xl px-6 py-10">
    <div class="rounded-3xl bg-white/90 p-8 shadow-2xl shadow-orange-100">
        ...
        <form class="mt-6 grid gap-4" data-validate-form action="<?= url("/admin/products/store") ?>"
        ...
        >
            ...
            <div class="flex flex-wrap gap-3">
                <button type="submit" class="rounded-2xl bg-brand-600 px-6 py-3 text-sm font-semibold text-white">Save
                </button>
                <button type="reset"
